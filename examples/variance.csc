...
<simconf>
  ...
  <simulation>
    ...
    <mote>
      ...
      <interface_config>
        ...
        <x>61.375303265025934</x>
        <y>44.303139454169276</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>15.004729154627308</x>
        <y>71.46945517236082</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspClock
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>19.53576235961858</x>
        <y>1.7056768247454834</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspClock
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>4.371894819430562 0.0 0.0 4.371894819430562 -37.962734021710176 51.04300975535169</viewport>
    </plugin_config>
    <width>400</width>
    <z>2</z>
    <height>400</height>

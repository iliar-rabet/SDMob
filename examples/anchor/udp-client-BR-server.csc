...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <description>Cooja Mote UDP Client</description>
    ...
    <motetype>
      org.contikios.cooja.contikimote.ContikiMoteType
      <identifier>mtype62</identifier>
      <description>Cooja Mote Slip Radio</description>
    ...
    <mote>
      <interface_config>
        ...
        <x>80.76681253975688</x>
        <y>48.06713755187315</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
      ...
      <motetype_identifier>mtype62</motetype_identifier>
    </mote>
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>58.89322456495395</x>
        <y>66.23709823298718</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>4.821394222243255 0.0 0.0 4.821394222243255 146.77540161549905 -78.44082743567387</viewport>
    </plugin_config>
    <width>919</width>
    <z>0</z>
    <height>594</height>

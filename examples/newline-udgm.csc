...
<simconf>
  ...
  <simulation>
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>7.853985021056431</x>
        <y>40.54072609525967</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspClock
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>66.11904251852931</x>
        <y>41.44349132504143</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspClock
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>2.457658280534284 0.0 0.0 2.457658280534284 66.70716983460963 44.08192053028448</viewport>
    </plugin_config>
    <width>400</width>
    <z>2</z>
    <height>400</height>
  ...
  <plugin>
    Mobility
    <plugin_config>
      <positions EXPORT="copy">[APPS_DIR]/mobility/linear2.dat</positions>
    </plugin_config>
    <width>500</width>
    <z>7</z>
    <height>200</height>
